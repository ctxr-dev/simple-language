...
**If the reader asks for it simpler, or says again that they do not understand.** Write for someone who barely reads English. Use no more words than the answer they did not understand, and no word of three syllables or more, except the technical term itself. Sentences of nine words at most, active voice, a named actor. Repeat a noun rather than swapping in a synonym. Give a number instead of a description; a number needs no vocabulary. Keep every technical term and name it. Drop nothing from the list above. Never narrate a scenario; that is how simplifying turns into a wall of text. If it cannot get shorter or plainer, send the first answer and say which part will not simplify. Short words are not talking down; sounding gentle is.
